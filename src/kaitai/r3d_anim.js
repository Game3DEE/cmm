...
var R3dAnim = (function() {
    function R3dAnim(_io, _parent, _root) {
      this._io = _io;
    ...
    R3dAnim.prototype._read = function() {
      this.animMagic = this._io.readBytes(8);
      if (!((KaitaiStream.byteArrayCompare(this.animMagic, [114, 51, 100, 50, 65, 110, 105, 109]) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError([114, 51, 100, 50, 65, 110, 105, 109], this.animMagic, this._io, "/seq/0");
      }
      this.animVersionMajor = this._io.readU2le();
      this.animVersionMinor = this._io.readU2le();
      ...
      if (!((KaitaiStream.byteArrayCompare(this.magic, [114, 51, 100, 50, 77, 101, 115, 104]) == 0))) {
        throw new KaitaiStream.ValidationNotEqualError([114, 51, 100, 50, 77, 101, 115, 104], this.magic, this._io, "/seq/7");
      }
    ...
    var Face = R3dAnim.Face = (function() {
    ...
    var Vector3f = R3dAnim.Vector3f = (function() {
    ...
    /**
     * One vertex more; might be a "center" or "pivot" or so?
     */
  
    return R3dAnim;
  })();
  
export default R3dAnim;
