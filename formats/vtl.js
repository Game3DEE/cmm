export function loadVTL(buffer) {
...
export function saveVTL(anim) {
    ...
    dv.setUint32(0, anim.vertCount, true)
    dv.setUint32(4, anim.fps, true)
    dv.setUint32(8, anim.frameCount, true)
    let offset = 12
